...
if ($balance_type !== 'outcome') {
    $html .= '<td>Приход:</td>';
    $html .= '<td class="csc-cm"><b>' . number_format($income_quantity, 0, ',', ' ')  . '</b></td>';
    $html .= '<td class="csc-cm"><b>' . number_format($income_sum, 0, ',', ' ')       . '</b></td>';
}
if ($balance_type !== 'income') {
    $html .= '<td>Расход:</td>';
    $html .= '<td class="csc-cm"><b>' . number_format($outcome_quantity, 0, ',', ' ') . '</b></td>';
    $html .= '<td class="csc-cm"><b>' . number_format($outcome_sum, 0, ',', ' ')      . '</b></td>';
}
    $html .= '<td> </td>';
    $html .= '</tr>';
